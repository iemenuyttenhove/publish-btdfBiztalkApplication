...
function deploy-btdfBiztalkApp() {
    ...
    try {
        ...
        if ($true -eq $mergeOctopusEnvironmentVariablesWithBtdfSettings) {
            ...
            Merge-OctopusEnvironmentVariablesWithBtdfSettings $deployOptionsNameValuePairs
        }
...
function Merge-OctopusEnvironmentVariablesWithBtdfSettings() {
    ...
    $envSettingsDirectory = (Get-Item $projectFile).Directory
    ...
    #TODO: Parse XML file and look for matching keys in Octopus variables to replace XML values.
